...
!*****************************************************************************80
!
!! MAIN is the main program for LYNX_PLOT.
!
!  Discussion:
!
!    LYNX_PLOT uses DISLIN to draw an XY plot of the Lynx harvest per year.
!
!    This example reads an XY data file containing an unknown number of
!    records, draws the data points and connectes them.
!
!  Licensing:
!
...
! use dislin
  ...
  write ( *, '(a)' ) '  Use DISLIN routines to plot (X,Y) data as a curve.'
!
!  Read the data.
!
  call r4mat_header_read ( 'lynx_data.txt', m, n )

  allocate ( xy(1:m,1:n) )

  call r4mat_data_read ( 'lynx_data.txt', m, n, xy )
!
...
!
  call graf ( 1821.0, 1934.0, 1830.0, 10.0, 0.0, 7000.0, 0.0, 1000.0 )
!
!  BEGIN LEVEL 2 COMMANDS.
!
!  Define the title.
!
  call titlin ( 'Annual Lynx Harvest', 1 )
  call titlin ( '1821-1934', 2 )
  call title ( )
!
...
!  Draw the curve.
!
  call curve ( xy(1,1:n), xy(2,1:n), n )
!
!  Set color to "blue".
!
  call color ( 'blue' )
