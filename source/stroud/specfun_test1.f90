...
!*****************************************************************************80
!
!! MAIN is the main program for SPECFUN_TEST1.
!
!  Discussion:
!
!    SPECFUN_TEST1 tests the SPECFUN library.
!
!  Licensing:
!
...
!
  ...
  jt = 0
!
!  Determine largest argument for R8_GAMMA_LOG by iteration.
!
  cl = xp99 * xmax
  z = -cl / x99
...
!
      if ( j /= 3 ) then
        ...
        v = ((( half - zz * p6875 ) - c1 ) - w * p6875 ) &
          - c3 * ( w + zz )
        v = ( ( v + r8_gamma_log ( y ) ) - r8_gamma_log ( z ) )
        ...
        u = r8_gamma_log ( x )
        v = ( c1 + ( ( x - half ) - half ) * c2 ) &
          + r8_gamma_log ( y ) + r8_gamma_log ( z ) - half
