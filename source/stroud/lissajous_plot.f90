...
! use dislin
  ...
  write ( *, '(a)' ) '  Use DISLIN routines to plot (X,Y) data as a plane curve.'
!
!  Read the data.
!
  call r4mat_header_read ( 'lissajous_data.txt', m, n )

  allocate ( xy(1:m,1:n) )

  call r4mat_data_read ( 'lissajous_data.txt', m, n, xy )
!
...
!
  call graf ( -1.1, 1.1, -1.0, 0.2, -1.1, 1.1, -1.0, 0.2 )
!
!  BEGIN LEVEL 2 COMMANDS.
!
!  Define the title.
!
  call titlin ( 'Lissajous Curve', 1 )
  call titlin ( 'x=sin(3t+pi/2), y=sin(4t)', 2 )
  call title ( )
!
