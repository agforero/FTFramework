...
!*****************************************************************************80
!
!! MAIN is the main program for SHOW_TWO.
!
!  Discussion:
!
!    SHOW_TWO writes out a copy of the Niederreiter sequence base 2.
!
...
!
  ...
  integer dimen
  character ( len = 80 ) :: file_out_name = 'show_two_test.txt'
  ...
  write ( *, '(a)' ) '  Show a Niederreiter sequence for a given'
...
!
  ...
  write ( file_out_unit, '(a)' ) ' '
  write ( file_out_unit, '(a)' ) '  I  QUASI(1)  QUASI(2)'
  write ( file_out_unit, '(a)' ) ' '
!
...
!
  do i = 1, seqlen
    ...
    write ( file_out_unit, '(i4,10f7.4)' ) i, quasi(1:dimen)
...
!    either CALCC or CALCC2.  The values transmitted through common 
!    /FIELD/ determine which field we are working in.
!
...
!
  ...
  real quasi(*)
  integer r
  real, parameter :: recip = 2.0E+00**(-nbits)
...
!    POLY(N), and the degree of the polynomial in POLY(-1).  The 
...
!
  ...
  integer add(0:maxq-1,0:maxq-1)
  character ( len = 80 ) :: file_in_name = 'gfarit.dat'
