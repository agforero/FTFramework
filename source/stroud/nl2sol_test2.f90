...
!*****************************************************************************80
!
!! MAIN is the main program for NL2SOL_TEST2.
!
!  Discussion:
!
!    NL2SOL_TEST2 tests the NL2SOL library.
!
...
!    Input, integer ( kind = 4 ) P, the number of variables.
!
!    Input, real ( kind = 8 ) X(P), the point at which the jacobian is to be 
!    evaluated.
!
